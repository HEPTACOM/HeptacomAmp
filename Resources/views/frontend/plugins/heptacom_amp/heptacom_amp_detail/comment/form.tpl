...
{block name='frontend_detail_comment_post_form'}
    <form method="get" target="_top" action="{url action='rating' sArticle=$sArticle.articleID sCategory=$sArticle.categoryID forceSecure}#detail--product-reviews" class="content--form review--form">
        ...
        {block name='frontend_detail_comment_input_rating'}
            <div class="field--select review--field">
                ...
                <select name="sVoteStars" class="btn is--large block">
