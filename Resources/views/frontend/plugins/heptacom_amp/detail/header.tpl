...
{block name='frontend_index_header_meta_tags_opengraph'}
    ...
    <meta property="og:url" content="{url sArticle=$sArticle.articleID title=$sArticle.articleName controller='detail' amp=1}" />
    ...
    <meta property="product:product_link" content="{url sArticle=$sArticle.articleID title=$sArticle.articleName controller='detail' amp=1}" />
