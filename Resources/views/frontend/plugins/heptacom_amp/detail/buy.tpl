{namespace name="frontend/detail/buy"}

{block name="frontend_detail_buy"}
    <form name="sAddToBasket" method="get" target="_top" action="{url controller=checkout action=addArticle forceSecure}" class="buybox--form" data-add-article="true" data-eventName="submit"{if $theme.offcanvasCart} data-showModal="false" data-addArticleUrl="{url controller=checkout action=ajaxAddArticleCart}"{/if}>
                            ...
                            {block name='frontend_detail_buy_quantity'}
                                <div class="buybox--quantity block">
                                    ...
                                    {block name='frontend_detail_buy_quantity_select'}
                                        <select id="sQuantity" name="sQuantity" class="quantity--select btn is--large block">
