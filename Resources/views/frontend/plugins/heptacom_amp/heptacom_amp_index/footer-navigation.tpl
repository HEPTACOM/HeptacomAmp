...
<amp-accordion disable-session-states>
    ...
    {block name="frontend_index_footer_column_service_hotline"}
        <section class="footer--column column--hotline is--first block">
            {block name="frontend_index_footer_column_service_hotline_headline"}
                <header class="column--headline">{s name="sFooterServiceHotlineHead"}{/s}</header>
            {/block}
    ...
    {block name="frontend_index_footer_column_service_menu"}
        <section class="footer--column column--menu block">
            {block name="frontend_index_footer_column_service_menu_headline"}
                <header class="column--headline">{s name="sFooterShopNavi1"}{/s}</header>
            {/block}
    ...
    {block name="frontend_index_footer_column_information_menu"}
        <section class="footer--column column--menu block">
            {block name="frontend_index_footer_column_information_menu_headline"}
                <header class="column--headline">{s name="sFooterShopNavi2"}{/s}</header>
            {/block}
    ...
    {block name="frontend_index_footer_column_newsletter"}
        <section class="footer--column column--newsletter is--last block">
            {block name="frontend_index_footer_column_newsletter_headline"}
                <header class="column--headline">{s name="sFooterNewsletterHead"}{/s}</header>
            {/block}
