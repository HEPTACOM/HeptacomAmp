{namespace name="frontend/plugins/notification/index"}
...
<div class="product--notification">
    ...
    {block name="frontend_detail_index_notification_form"}
        {if !$NotifyAlreadyRegistered}
            <form method="get" target="_top" action="{url action='notify' sArticle=$sArticle.articleID}" class="notification--form block-group">
